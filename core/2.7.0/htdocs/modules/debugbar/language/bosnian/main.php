...
define('_MD_DEBUGBAR_DEBUG', 'Otklanjanje grešaka');
...
define('_MD_DEBUGBAR_TIMERS', 'Mjerači vremena');
define('_MD_DEBUGBAR_TIMETOLOAD', '%s je učitan za %s sekundi.');
define('_MD_DEBUGBAR_TOTAL', 'Ukupno');
define('_MD_DEBUGBAR_NOT_CACHED', 'Nije keširano');
define('_MD_DEBUGBAR_CACHED', 'Keširano (osvježava se svakih %s sekundi)');
...
define('_MD_DEBUGBAR_QUERY_ERROR', '-- Broj greške: %s Poruka o grešci: %s');
define('_MD_DEBUGBAR_QUERY_ERROR_RAY', "
-- Greška #%s: %s");

// Ray labels
define('_MD_DEBUGBAR_RAY_EXCEPTION', 'Izuzetak');
define('_MD_DEBUGBAR_RAY_QUERY', 'Upit #%d');
define('_MD_DEBUGBAR_RAY_DUP', '[DUP x%d]');
define('_MD_DEBUGBAR_RAY_SLOW', 'SPORO');
define('_MD_DEBUGBAR_RAY_BLOCK_CACHED', 'Blokiraj (keširano %ds)');
define('_MD_DEBUGBAR_RAY_BLOCK_NOT_CACHED', 'Blok (nije keširano)');
...
define('_MD_DEBUGBAR_ERR_DIR_CREATE', 'Direktorij "modules/debugbar/%s" nije kreiran');
define('_MD_DEBUGBAR_ERR_DIR_COPY', 'Nije uspjelo kreiranje direktorija "%s" tokom kopiranja sredstva');
