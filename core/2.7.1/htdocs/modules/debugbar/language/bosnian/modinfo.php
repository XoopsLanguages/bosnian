...
define('_MI_DEBUGBAR_FILESDEBUG', 'Omogući tab uključenih datoteka');
define('_MI_DEBUGBAR_FILESDEBUG_DSC', 'Prikaži sve PHP datoteke učitane tokom zahtjeva');
define('_MI_DEBUGBAR_SLOWQUERY', 'Prag sporog upita (sekunde)');
define('_MI_DEBUGBAR_SLOWQUERY_DSC', 'Upiti sporiji od ovoga su označeni crvenom bojom (npr. 0.05 = 50ms)');

define('_MI_DEBUGBAR_QUERYMODE',      'Zapisivanje upita');
...
//help multipage
\define('_MI_DEBUGBAR_DISCLAIMER', 'Odricanje odgovornosti');
